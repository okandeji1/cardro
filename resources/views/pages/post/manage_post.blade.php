        ...
        <section class="section">
            ...
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">manage Posts</h4>
                </li>
            </ul>
                                            ...
                                            <tbody>
                                                @foreach ($posts as $key => $post)
                                                    <tr>
                                                        ...
                                                        <td><a href="/edit-admin/{{ $post->uuid }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="itemModalLabel">Add New Post</h5>
                ...
                <form action="/add-post" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-float col-12">
                        <div class="form-line">
                            ...
                            <input type="text" class="form-control :class=" { 'is-invalid' : form.errors.has('title') }"
                                name="title" id="title" placeholder="Post title" required>
                    ...
                    <div class="form-group form-float col-12">
                        <div class="form-line">
                            ...
                            <textarea name="description" id="" cols="30" rows="10" class="form-control :class="
                                { 'is-invalid' : form.errors.has('description') }" id="description"
